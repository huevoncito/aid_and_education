!function() {
	function a(a) {
		this.svg = d3.select(a)
			.append("svg")
			.attr("width", a.offsetWidth)
			.attr("class", "datamap")
			.attr("height", a.offsetHeight)
			.call(d3.behavior.zoom()
				.on('zoom', function() {
					redraw( $(this).find('.datamaps-subunits') );
					redraw( $(this).find('.datamaps-bubble') );
				})
			);
	...
	function i(a, b, c) {
		...
		})//.style("stroke", c.borderColor)
			//.style("stroke-width", c.borderWidth)
			.style("fill-opacity", c.fillOpacity).style("fill", function(a) {
			var b = e[a.fillKey];
			return 'crimson'//b || e.defaultFill
